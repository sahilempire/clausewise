...
const ContractForm: React.FC<ContractFormProps> = ({ onGenerate }) => {
  ...
  const { isExpanded, setIsExpanded, toggleExpanded } = useExpandedPreview();
  ...
  return (
    <div className={`w-full max-w-6xl grid grid-cols-1 gap-6 relative ${isExpanded ? 'lg:grid-cols-5' : 'md:grid-cols-2'}`}>
      ...
      >
        ...
        <motion.div 
          className="relative overflow-auto h-[500px] border border-bento-gray-200 rounded-lg p-4 bg-white dark:bg-bento-gray-800 dark:border-bento-gray-700 text-sm"
